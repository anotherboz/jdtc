...
export function fadeInX(a: number | string, b: number | string) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function fadeInY(a: number | string, b: number | string) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function fadeOutY(a: number | string, b: number | string) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function slideX(a: number | string, b: number | string) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function slideY(a: number | string, b: number | string) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
